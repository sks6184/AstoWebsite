...
def build_prediction_evidence(
    ...
    chart_facts = build_chart_facts(chart_data, category)
    ...
    varga_assessment = build_varga_assessment(chart_facts, category)
    ...
    evidence_json["triggered_rules"] = rule_result["triggered_rules"]
    evidence_json["summary_scores"] = aggregate_scores(rule_result["triggered_rules"], category)
